...
.fragment(:class="{'fade-out':fadeOut}")
  ...
  .fragment__container
    ...
    .fragment__container-data
        .container-data
            .container-data__title Faça o login ou cadastre-se
            .container-data__subtitle Faça login para responder a diferentes testes, participar de desafios e muito mais.
